...
import static com.horizon.offer.home.discovery.videos.Align.BOTTOM;
import static com.horizon.offer.home.discovery.videos.Align.LEFT;
import static com.horizon.offer.home.discovery.videos.Align.RIGHT;
import static com.horizon.offer.home.discovery.videos.Align.TOP;


public class VideosLayoutManager extends RecyclerView.LayoutManager {
    ...
    public VideosLayoutManager(Config config) {
        this();
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (event.getAction() == MotionEvent.ACTION_UP) {
                ...
                if (Math.abs(xVelocity) < mMinVelocityX && o != 0) {
                    ...
                    if (mCallBack != null) {
                        mCallBack.display(mTotalOffset / mUnit);
                    }
                }
            }
            return false;
    ...
    private void brewAndStartAnimator(int dur, int finalXorY) {
        animator = ObjectAnimator.ofInt(VideosLayoutManager.this, "animateValue", 0, finalXorY);
